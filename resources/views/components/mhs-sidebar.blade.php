...
<div x-data="{ open: {{ request()->routeIs('profile.*') || request()->routeIs('user.*') ? 'true' : 'false' }} }" :class="collapsed ? 'w-20' : 'w-64'"
    ...
    <nav class="flex-1 px-3 py-4 space-y-2 text-gray-800 text-sm font-medium overflow-y-auto">
        ...
        <a href="{{ route('mahasiswa.dashboard') }}"
            class="flex items-center gap-3 px-3 py-2 text-sm rounded-lg hover:bg-gray-100 transition-all {{ request()->routeIs('mahasiswa.dashboard') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-800' }}"
        ...
        <a href="{{ route('mhs.bimbingan.index') }}"
            class="flex items-center gap-3 px-3 py-2 text-sm rounded-lg hover:bg-gray-100 transition-all {{ request()->routeIs('mhs.bimbingan.*') ? 'text-blue-600 font-semibold' : 'text-gray-800' }}"
