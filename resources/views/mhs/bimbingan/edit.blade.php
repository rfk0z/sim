<x-dosen-layout>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex justify-end">
            <a href="{{ route('mahasiswa.bimbingan.show', $bimbingan->id_bimbingan) }}"
    ...
    <div x-data="{ showPdf: false, pdfUrl: '' }">
        <form action="{{ route('mahasiswa.bimbingan.update', $bimbingan->id_bimbingan) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
